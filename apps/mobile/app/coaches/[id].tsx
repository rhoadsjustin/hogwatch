...
import { AskChatGPT, Card, EmptyState, Eyebrow, LoadingState, SectionHeader, TrendBars } from '@/components/ui';
...
export default function CoachReportScreen() {
  ...
  return <ScrollView contentInsetAdjustmentBehavior="automatic" contentContainerStyle={{ padding: 18, paddingBottom: 38, gap: 24 }}>
    ...
    <AskChatGPT entity="coach" id={coach.id} metricIds={['hog-index']} chatClient={hogWatchMobileChat} />
  </ScrollView>;
}
